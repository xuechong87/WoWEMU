...
Rochet2 TeLe [] = // key = i & Key
{
	...
	{1,	0,	2,	"达纳苏斯",	0,	0,	2,	1,	9869.91f,	2493.58f,	1315.88f,	2.78897f},
	...
	{1,	0,	2,	"沙塔斯城",	0,	57,	0,	530,	-1887.62f,	5359.09f,	-12.4279f,	4.40435f},
	...
	{1,	2,	9,	"初级",	0,	15,	0,	0,	0,	0,	0,	0},
	{1,	3,	9,	"中级",	0,	59,	0,	0,	0,	0,	0,	0},
	{1,	4,	9,	"高级",	0,	69,	0,	0,	0,	0,	0,	0},
	{1,	5,	9,	"团队",	0,	57,	0,	0,	0,	0,	0,	0},

	{2,	0,	2,	"诺莫瑞根",	0,	25,	2,	0,	-5163.54f,	925.423f,	257.181f,	1.57423f},
	{2,	0,	2,	"死亡矿井",	0,	17,	2,	0,	-11209.6f,	1666.54f,	24.6974f,	1.42053f},
	...
	{4,	0,	2,	"蜘蛛王国",	0,	73,	0,	571,	3707.86f,	2150.23f,	36.76f,	3.22f},
	{4,	0,	2,	"净化斯坦索姆",	0,	79,	0,	1,	-8756.39f,	-4440.68f,	-199.489f,	4.66289f},
	{4,	0,	2,	"勇士的试炼",	0,	79,	0,	571,	8590.95f,	791.792f,	558.235f,	3.13127f},
	{4,	0,	2,	"达克萨隆要塞",	0,	74,	0,	571,	4765.59f,	-2038.24f,	229.363f,	0.887627f},
	{4,	0,	2,	"古达克",	0,	71,	0,	571,	6722.44f,	-4640.67f,	450.632f,	3.91123f},
	{4,	0,	2,	"冰冠城塞",	0,	79,	0,	571,	5643.16f,	2028.81f,	798.274f,	4.60242f},
	{4,	0,	2,	"魔枢",	0,	71,	0,	571,	3782.89f,	6965.23f,	105.088f,	6.14194f},
	{4,	0,	2,	"紫罗兰监狱",	0,	75,	0,	571,	5693.08f,	502.588f,	652.672f,	4.0229f},
	{4,	0,	2,	"闪电大厅",	0,	79,	0,	571,	9136.52f,	-1311.81f,	1066.29f,	5.19113f},
	{4,	0,	2,	"岩石大厅",	0,	77,	0,	571,	8922.12f,	-1009.16f,	1039.56f,	1.57044f},
	{4,	0,	2,	"乌特加德城堡",	0,	69,	0,	571,	1203.41f,	-4868.59f,	41.2486f,	0.283237f},
	{4,	0,	2,	"乌特加德之巅",	0,	75,	0,	571,	1267.24f,	-4857.3f,	215.764f,	3.22768f},
	{4,	1,	7,	"返回",	0,	0,	0,	0,	0,	0,	0,	0},

	{5,	0,	2,	"黑暗神殿",	0,	70,	0,	530,	-3649.92f,	317.469f,	35.2827f,	2.94285f},
	...
	{5,	0,	2,	"冰冠城塞",	0,	80,	0,	571,	5855.22f,	2102.03f,	635.991f,	3.57899f},
	...
	{5,	0,	2,	"太阳井高地",	0,	70,	0,	530,	12574.1f,	-6774.81f,	15.0904f,	3.13788f},
	{5,	0,	2,	"风暴之眼",	0,	67,	0,	530,	3088.49f,	1381.57f,	184.863f,	4.61973f},
	{5,	0,	2,	"安其拉神殿",	0,	60,	0,	1,	-8240.09f,	1991.32f,	129.072f,	0.941603f},
	{5,	0,	2,	"永恒之眼",	0,	80,	0,	571,	3784.17f,	7028.84f,	161.258f,	5.79993f},
	{5,	0,	2,	"黑耀石神殿",	0,	80,	0,	571,	3472.43f,	264.923f,	-120.146f,	3.27923f},
	{5,	0,	2,	"奥杜尔",	0,	80,	0,	571,	9222.88f,	-1113.59f,	1216.12f,	6.27549f},
	{5,	0,	2,	"阿尔卡冯的宝库",	0,	80,	0,	571,	5453.72f,	2840.79f,	421.28f,	0.0f},
	...
	{6,	0,	2,	"幽魂之地",	0,	10,	1,	530,	7595.73f,	-6819.6f,	84.3718f,	2.56561f},
	...
	{6,	0,	2,	"奥特兰克山脉",	0,	30,	0,	0,	275.049f,	-652.044f,	130.296f,	0.502032f},
	...
	{6,	0,	2,	"西瘟疫之地",	0,	51,	0,	0,	1743.69f,	-1723.86f,	59.6648f,	5.23722f},
	{6,	0,	2,	"东瘟疫之地",	0,	53,	0,	0,	2280.64f,	-5275.05f,	82.0166f,	4.7479f},
	...
	{7,	0,	2,	"血雾岛",	0,	15,	2,	530,	-2095.7f,	-11841.1f,	51.1557f,	6.19288f},
	...
	{8,	1,	7,	"返回",	0,	0,	0,	0,	0,	0,	0,	0},

	{9,	0,	2,	"北风苔原",	0,	68,	0,	571,	2954.24f,	5379.13f,	60.4538f,	2.55544f},
	{9,	0,	2,	"嚎风峡湾",	0,	68,	0,	571,	682.848f,	-3978.3f,	230.161f,	1.54207f},
	{9,	0,	2,	"龙骨荒野",	0,	71,	0,	571,	2678.17f,	891.826f,	4.37494f,	0.101121f},
	{9,	0,	2,	"灰熊丘陵",	0,	73,	0,	571,	4017.35f,	-3403.85f,	290.0f,	5.35431f},
	{9,	0,	2,	"祖尔德拉克",	0,	74,	0,	571,	5560.23f,	-3211.66f,	371.709f,	5.55055f},
	{9,	0,	2,	"肖拉查盆地",	0,	76,	0,	571,	5614.67f,	5818.86f,	-69.722f,	3.60807f},
	{9,	0,	2,	"晶歌森林",	0,	77,	0,	571,	5411.17f,	-966.37f,	167.082f,	1.57167f},
	{9,	0,	2,	"风暴之巅",	0,	77,	0,	571,	6120.46f,	-1013.89f,	408.39f,	5.12322f},
	{9,	0,	2,	"冰冠城塞",	0,	77,	0,	571,	8323.28f,	2763.5f,	655.093f,	2.87223f},
	{9,	0,	2,	"冬拥湖",	0,	77,	0,	571,	4522.23f,	2828.01f,	389.975f,	0.215009f},
	{9,	1,	7,	"返回",	0,	0,	0,	0,	0,	0,	0,	0},
...
#define ARE_YOU_SURE	"你想要去 "
#define ERROR_COMBAT	"|cffff0000正在战斗中|r"
